    ...
    <header className="fixed top-0 left-0 right-0 z-50 w-full px-4 md:px-6 py-4 pointer-events-none">
      ...
      <div className="mx-auto max-w-7xl glass-panel rounded-2xl px-4 md:px-6 py-3.5 flex items-center justify-between border border-white/8 float-header pointer-events-auto">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <span className="text-xs md:text-sm font-extrabold tracking-widest text-white text-glow-cyan">
            ASIWAJU <span className="text-cyan-400 hidden sm:inline">AI HUB</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          >
            <svg className="h-3.5 w-3.5 text-[#229ED9]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          >
            <svg className="h-3.5 w-3.5 text-[#5865F2]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <span className="hidden xs:inline">Discord</span> <span className="xs:hidden">DC</span>
          </a>
